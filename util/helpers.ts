...
export async function deployWalletApproverService(
  ...
  const rewardWei = ethers.utils.parseEther(rewardPerApprove);
  const walletApproverService = await WalletApproverService.deploy(masterWalletApprover, walletApprovers, rewardWei);
